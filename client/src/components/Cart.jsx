...
import {  dishChange, dishAdd, dishRemove,removeDishFromCart, } from "./slices/cartSlice";
...
export default function Cart() {
  ...
  const checkout = () => {
    if(dishList.find(e=>e.quantity === 0)){
        alert("There is some dish with 0 quantity. Please remove the dish from the cart.");
    }
    else{
    setIsChkout(true);
  }
                ...
                <div className="right-part">
                  ...
                  <p>
                    <input
                      ...
                      // id="reduce"
                      value="-"
                      onClick={() => dispatch(dishRemove(item.item_id))
                    ...
                    <input
                      ...
                      onChange={(e) =>{
                        ...
                        dispatch(dishChange({item_id: item.item_id, quantity}))
                      }
                    ...
                    <input
                      ...
                      id="add"
                      value="+"
                      onClick={() => dispatch(dishAdd(item.item_id))
                  ...
                  <p className="item-amount remove-btn">
                    ...
                    <button onClick={() => dispatch(removeDishFromCart(item.item_id))
