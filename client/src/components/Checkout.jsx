...
const ORDER_URL =
  "https://6fdhemeqha.execute-api.ca-central-1.amazonaws.com/dev/api/order/";
let order_id;
let total_price;
export default function Checkout() {
  ...
  const validationSchema = Yup.object().shape({
    ...
    postcode: Yup.string()
      ...
      .matches(
        /^(?!.*[DFIOQU])[A-VXY][0-9][A-Z]\s?[0-9][A-Z][0-9]$/gm,
    ...
    phone: Yup.string()
      ...
      .matches(
        ...
        "This is a invalid phone number. Use ten digits or (xxx)-xxx-xxxx format for the phone number."
      ),
  ...
  let totalAmount = Math.round(
    ((shippingFee + subTotal(dishList)) * 100) / 100
  );
                ...
                <div className="billing-form">
                  ...
                  <div className="city-wrap">
                    ...
                    <div style={{ margin: "0 1rem" }}>
                      ...
                      <br />
                      <Field name="state" as="select" placeholder="select">
                      <option value=""></option>
